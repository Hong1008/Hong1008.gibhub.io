...
<link rel="stylesheet" href="/tmi/css/dashMain.css">
<link rel="stylesheet" href="/tmi/css/an-skill-bar.css">
...
<%@include file="../include/aside.jsp"%>
      ...
      <div class="w3-container" style="z-index:3;">
     	 <div id="test" style="background-image: url('../images/bg1.png'); border-style:solid; background-size: 110px; width: 130px; height: 90px; float: left; margin-left: 1%; margin-top: 1%;">
     	 <input type="checkbox">
      <!--  <img src="../images/bg.jpg" style="width: 130px; height: 90px; float: left; margin-left: 2%; margin-top: 1%;"> -->
      	</div>
       <img src="../images/bg1.png" style="width: 130px; height: 90px; float: left; margin-left: 1%; margin-top: 1%;">
       <img src="../images/bg2.jpg" style="width: 130px; height: 90px; float: left; margin-left: 1%; margin-top: 1%;">
       <img src="../images/bg3.jpg" style="width: 130px; height: 90px; float: left; margin-left: 1%; margin-top: 1%;">
       </br>
        <img src="../images/bg5.png" style="width: 130px; height: 90px; float: left; margin-left: 2%; margin-top: 1%;">
        <img src="../images/bg6.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
        <img src="../images/bg7.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
        <img src="../images/bg8.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
        </br>
        <img src="../images/su1.jpg" style="width: 130px; height: 90px;float: left; margin-left: 2%; margin-top: 1%;">
        <img src="../images/su2.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
        <img src="../images/su3.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
        <img src="../images/su4.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
        </br>
       <img src="../images/su5.jpg" style="width: 130px; height: 90px;float: left; margin-left: 2%; margin-top: 1%;">
       <img src="../images/su6.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
       <img src="../images/su7.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
       <img src="../images/su8.jpg" style="width: 130px; height: 90px;float: left; margin-top: 1%; margin-left: 1%;">
      </div>
...
<script src="/tmi/js/svg-donut-chart-framework.js"></script>
<script src="/tmi/js/jquery.pista.min.js"></script> <!-- 곡선그래프 -->
<script src="//cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
<script src="/tmi/js/an-skill-bar.js"></script>
<script src="/tmi/js/DashMainGraph.js"></script>
