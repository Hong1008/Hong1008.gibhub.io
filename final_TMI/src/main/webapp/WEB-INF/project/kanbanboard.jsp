...
<link href='../css/project_schedule.css' type='text/css'
	rel='stylesheet'>
...
<body>
	...
	<form id="sch-form" class="modal" action="project/insertProject">
		<label for="sch_name">스케줄 제목</label> <input type="text"
			required="required" id="sch_name" name="sch_name"
			placeholder="스케줄 제목"> <label for="sch_info">스케줄 간단설명</label>
		<input type="text" required="required" id="sch_info" name="sch_info"
			placeholder="스케줄 간단설명"> <label for="sch_start">스케줄 기간</label>
		<input type="text" readonly="readonly" class="start"
	...
	<form id="t-form" class="modal" action="project/insertProject">
		...
		<label for="t_start">할일 기간</label> <input type="text"
			readonly="readonly" class="start" required="required" id="t_start"
			name="t_start" placeholder="할일 시작일"> <input type="text"
			readonly="readonly" class="end" required="required" id="t_end"
			name="t_end" placeholder="할일 종료일">
		<ul>
